...
- Home: título da aba exibe `FoKus Pomodoro`.
- Histórico: título da aba exibe `Histórico - FoKus Pomodoro`.
- Configurações: título da aba exibe `Configurações - FoKus Pomodoro`.
- Sobre: título da aba exibe `Entenda a Técnica Pomodoro - FoKus Pomodoro`.
- 404: título da aba exibe `Página não encontrada - FoKus Pomodoro`.
...
export function History() {
  ...
  useEffect(() => {
    document.title = 'Histórico - FoKus Pomodoro';
  }, []);
...
export function Settings() {
  ...
  useEffect(() => {
    document.title = 'Configurações - FoKus Pomodoro';
  }, []);
...
export function AboutPomodoro() {
  useEffect(() => {
    document.title = 'Entenda a Técnica Pomodoro - FoKus Pomodoro';
  }, []);
...
export function NotFound() {
  useEffect(() => {
    document.title = 'Página não encontrada - FoKus Pomodoro';
  }, []);
...
- [ ] Os títulos seguem um padrão consistente com `FoKus Pomodoro`.
