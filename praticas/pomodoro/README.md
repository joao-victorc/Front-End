...
- Home: título da aba exibe `FoKus InterVal`.
- Histórico: título da aba exibe `Histórico - FoKus InterVal`.
- Configurações: título da aba exibe `Configurações - FoKus InterVal`.
- Sobre: título da aba exibe `Entenda a Técnica Pomodoro - FoKus InterVal`.
- 404: título da aba exibe `Página não encontrada - FoKus InterVal`.
...
export function History() {
  ...
  useEffect(() => {
    document.title = 'Histórico - FoKus InterVal';
  }, []);
...
export function Settings() {
  ...
  useEffect(() => {
    document.title = 'Configurações - FoKus InterVal';
  }, []);
...
export function AboutPomodoro() {
  useEffect(() => {
    document.title = 'Entenda a Técnica Pomodoro - FoKus InterVal';
  }, []);
...
export function NotFound() {
  useEffect(() => {
    document.title = 'Página não encontrada - FoKus InterVal';
  }, []);
...
- [ ] Os títulos seguem um padrão consistente com `FoKus InterVal`.
